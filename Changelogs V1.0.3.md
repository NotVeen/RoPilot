...
- **Utility Dashboard**:
  - **Account Overview**: Displays detailed info like username, display name, robux, account age, and Roblox Plus status.
  - **Display Name Editing**: Change your Display Name directly from RoPilot.
