...
cl.exe /EHsc /MD /O2 /std:c++17 /DUNICODE /D_UNICODE /I vendor\webview2\include /I vendor src\main.cpp src\AccountManager.cpp src\SettingsManager.cpp src\Updater.cpp src\Launcher.cpp src\RobloxAPI.cpp src\BrowserLogin.cpp src\HandleCloser.cpp src\ActiveClientLock.cpp src\Optimizer.cpp src\DiscordRPC.cpp src\Crypto.cpp src\WatchdogManager.cpp src\WebhookManager.cpp build\app.res /link winhttp.lib ole32.lib advapi32.lib shell32.lib shlwapi.lib user32.lib gdi32.lib crypt32.lib psapi.lib bcrypt.lib dwmapi.lib vendor\WebView2Loader.dll.lib /SUBSYSTEM:WINDOWS /OUT:RoPilot.exe /pdb:build\RoPilot.pdb
