            ...
            <div class="manage-content" style="flex-grow: 1; padding: 32px 48px; overflow-y: auto; display: flex; flex-direction: column; position: relative;">
                ...
                <div id="manage-home" class="manage-page" style="display: none; flex-direction: column; gap: 32px; animation: fadeSlideIn 0.3s ease forwards;">
                    ...
                    <div class="manage-overview-list" style="display: flex; flex-direction: column; gap: 0;">
                        <div class="overview-item" style="display: flex; align-items: center; padding: 16px 8px; border-bottom: 1px solid var(--border-color);">
                        ...
                        <div class="overview-item" style="display: flex; align-items: center; padding: 16px 8px; border-bottom: 1px solid var(--border-color);">
                            <div class="overview-icon" style="margin-right: 16px; width: 24px; display: flex; justify-content: center;">
                                <img src="https://img.icons8.com/color/48/robux--v2.png" style="width: 22px; height: 22px; filter: grayscale(100%) brightness(0); -webkit-filter: grayscale(100%) brightness(0);" class="dynamic-icon"/>
                            </div>
                            <div class="overview-text" style="flex-grow: 1;">
        ...
        manageTabs.forEach(tab => {
            tab.addEventListener('click', () => {
                ...
                if (target === 'manage-home') {
                    ...
                    el.offsetHeight;
                    el.style.animation = 'fadeSlideIn 0.3s ease forwards';
                } else {
                    document.getElementById('manage-home').style.display = 'none';
