...
<head>
    ...
    <style>
        ...
        * { 
        ...
        html[data-theme='dark'] #utility-modal .modal-content {
            background-color: #000000 !important;
            border-color: #222 !important;
        }
        html[data-theme='dark'] .utility-topbar {
            background-color: #000000 !important;
...
<body>
    ...
    <!-- Create Group Modal -->
    <div id="group-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center;">
    ...
    <!-- Update Prompt Modal -->
    <div id="update-prompt-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center;">
    ...
    <!-- Changelog Modal -->
    <div id="changelog-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center;" onclick="if(event.target === this) this.classList.remove('show');">
    ...
    <!-- Utility Modal -->
    <div id="utility-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0, 0, 0, 0.8); z-index: 1000; align-items: center; justify-content: center; opacity: 0; pointer-events: none; transition: opacity 0.3s ease; display: flex; backdrop-filter: blur(4px);">
        <div class="modal-content utility-modal-content" style="position: relative; transform: scale(0.95); transition: transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275); display: flex; flex-direction: column; width: 800px; max-width: 90vw; height: 600px; max-height: 85vh; padding: 0; overflow: hidden; border-radius: 12px; border: 1px solid var(--border-color);">
            <div class="utility-topbar" style="position: relative; display: flex; align-items: center; justify-content: center; gap: 32px; padding: 4px 16px; border-bottom: 1px solid var(--border-color);">
                <div id="utility-tab-indicator" style="position: absolute; bottom: 0; left: 0; height: 2px; width: 20px; background-color: var(--text-main); transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1); border-radius: 2px 2px 0 0;"></div>
                ...
                <div class="utility-tab" data-tab="utility-outfits" title="Outfits">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.38 3.46L16 2a8.59 8.59 0 0 0-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z"></path></svg>
                </div>
                <div class="utility-tab" data-tab="utility-globe" title="Roblox Experience" data-i18n-title="lbl_roblox_experience">
                ...
                <button class="utility-header-close" onclick="closeUtilityModal()" style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); background: none; border: none; color: var(--text-muted); cursor: pointer; padding: 4px; border-radius: 4px; display: flex; align-items: center; justify-content: center; transition: all 0.2s;">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                </button>
            </div>
            
            <div class="utility-content" style="flex-grow: 1; padding: 32px 48px; overflow-y: auto; display: flex; flex-direction: column; position: relative;">
                <div id="utility-loading" style="display: flex; flex-direction: column; align-items: center; justify-content: center; position: absolute; inset: 0; background: var(--bg-card); z-index: 10;">
                ...
                <div id="utility-home" class="utility-page" style="display: none; flex-direction: column; gap: 16px;">
                    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; gap: 12px; margin-bottom: 8px;">
                        <img draggable="false" id="utility-avatar" src="" style="width: 90px; height: 90px; border-radius: 50%; border: 2px solid var(--border-color); object-fit: cover;">
                        <div style="display: flex; flex-direction: column; gap: 4px; align-items: center;">
                            <h2 id="utility-title-username" style="margin: 0; font-size: 28px; color: var(--text-main); font-weight: 700; letter-spacing: -0.5px;">Username</h2>
                ...
                <div id="utility-outfits" class="utility-page" style="display: none; flex-direction: column; height: 100%; padding: 0; overflow-y: auto;">
                    ...
                    <div style="padding: 0px 20px 0px 20px; display: flex; flex-direction: column; align-items: center; border-bottom: 1px solid var(--border-color);">
                        <div style="width: 250px; height: 250px; margin: -10px auto 5px auto; border-radius: 12px; background: linear-gradient(90deg, rgba(255,255,255,0.05) 25%, rgba(255,255,255,0.15) 50%, rgba(255,255,255,0.05) 75%); background-size: 200% 100%; animation: loadingSkeleton 1.5s infinite linear; position: relative;" id="outfit-current-avatar-container">
                            <img draggable="false" id="outfit-current-avatar" src="" style="width: 100%; height: 100%; object-fit: contain; opacity: 0; transition: opacity 0.3s; position: absolute; top: 0; left: 0;" onload="this.style.opacity='1'; let c = document.getElementById('outfit-current-avatar-container'); c.style.animation='none'; c.style.background='none';" />
                        </div>
                        <div style="display: flex; flex-direction: column; gap: 4px; align-items: center; margin-bottom: 16px;">
                            <h2 style="margin: 0; font-size: 20px; color: var(--text-main); font-weight: 700; letter-spacing: -0.5px;" data-i18n="lbl_outfit_changer">Outfit Changer</h2>
                        </div>
                    </div>
    ...
    <span data-i18n="lbl_loading_outfits" style="color: var(--text-muted); font-weight: 500;">Loading outfits...</span>
                ...
                <div id="utility-globe" class="utility-page" style="display: none; flex-direction: column; height: 100%; color: var(--text-main); padding: 8px 16px 16px 16px; overflow-y: auto;">
                    
                    <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 8px;">
                        <h3 style="margin: 0; font-size: 16px; color: var(--text-main);" data-i18n="lbl_game_launch_setup">Game Launch Setup</h3>
                    </div>
                    <hr style="border: 0; border-top: 1px solid var(--border-color); margin: 0 0 12px 0; width: 100%;">
                    
                    <div style="margin-bottom: 4px; position: relative; padding-bottom: 16px;">
                        <label style="display: block; margin-bottom: 6px; font-size: 13px; font-weight: 500;" data-i18n="lbl_game_id">Place ID / Game ID</label>
                        <input type="text" id="global-game-id" class="settings-input" placeholder="e.g. 123456789" style="width: 100%; box-sizing: border-box; transition: border-color 0.2s;" onchange="validateGameLaunchInputs()">
                        <div id="game-id-error" style="position: absolute; bottom: 0; left: 0; font-size: 11px; color: #ef4444; display: none;"></div>
                    </div>
                    ...
                    <div style="margin-bottom: 4px; position: relative; padding-bottom: 16px;">
                        ...
                        <input type="text" id="global-ps-link" class="settings-input" placeholder="https://www.roblox.com/games/... or share?code=..." style="width: 100%; box-sizing: border-box; transition: border-color 0.2s;" onchange="validateGameLaunchInputs()">
                        <div id="ps-link-error" style="position: absolute; bottom: 0; left: 0; font-size: 11px; color: #ef4444; display: none;"></div>
                    </div>
                    
                    <p style="margin: 4px 0 16px 0; font-size: 12px; color: var(--text-muted);" data-i18n="lbl_game_launch_desc">
                        When filled, clicking "Launch" on any account card will automatically launch them into this specific game/server.
                    </p>
                    
                    <div style="display: flex; justify-content: center; align-items: center; margin-top: 16px; margin-bottom: 12px; position: relative;">
                        <h3 style="margin: 0; font-size: 16px; color: var(--text-main); display: flex; align-items: center; gap: 8px;">
                            <span data-i18n="lbl_recent_games">Recent Games</span>
                        </h3>
                        <button id="btn-refresh-recent-games" class="btn-icon" style="position: absolute; right: 0; background: transparent; border: none; padding: 4px; border-radius: 4px; cursor: pointer; color: var(--text-muted);" title="Refresh">
                    ...
                    <hr style="border: 0; border-top: 1px solid var(--border-color); margin: 0 0 16px 0; width: 100%;">
                        
                        <div style="position: relative; padding: 0 16px;">
                            <button id="btn-scroll-recent-left" class="btn-icon" style="position: absolute; left: 0px; top: 50%; transform: translateY(-50%); z-index: 10; background: var(--bg-hover); border: 1px solid var(--border-color); border-radius: 50%; width: 32px; height: 32px; display: none; align-items: center; justify-content: center; box-shadow: 0 4px 6px rgba(0,0,0,0.3); color: var(--text-main); padding: 0;">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"></polyline></svg>
                            </button>
                            
                            <div id="recent-games-container" style="display: flex; gap: 12px; overflow-x: auto; padding: 10px 4px; scroll-behavior: smooth; scrollbar-width: none;">
                                <!-- Games will be inserted here -->
                                <div style="color: var(--text-muted); font-size: 13px; font-style: italic; padding: 12px; margin: 0 auto;" data-i18n="lbl_no_recent_games">No recent games found. Select an account to fetch.</div>
                            </div>
                            
                            <button id="btn-scroll-recent-right" class="btn-icon" style="position: absolute; right: 0px; top: 50%; transform: translateY(-50%); z-index: 10; background: var(--bg-hover); border: 1px solid var(--border-color); border-radius: 50%; width: 32px; height: 32px; display: none; align-items: center; justify-content: center; box-shadow: 0 4px 6px rgba(0,0,0,0.3); color: var(--text-main); padding: 0;">
...
<!-- Add Account Modal -->
    <div id="modal-add-account" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center;">
    ...
    <!-- Cookie Login Modal -->
    <div id="cookie-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center;">
    ...
    <!-- Wear Outfit Modal -->
    <div id="wear-outfit-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center; opacity: 0; pointer-events: none; transition: opacity 0.2s ease; display: flex; backdrop-filter: blur(4px);">
        <div id="wear-outfit-modal-content" style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 12px; width: 350px; max-width: 90%; overflow: hidden; display: flex; flex-direction: column; transform: scale(0.95); transition: transform 0.2s ease;">
            ...
            <div style="padding: 20px; text-align: center;">
                <img draggable="false" id="wear-outfit-image" src="" style="width: 150px; height: 150px; border-radius: 12px; background: var(--bg-main); border: 1px solid var(--border-color); margin-bottom: 16px; object-fit: cover;" />
    ...
    <!-- Display Name Modal -->
    <div id="display-name-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center; opacity: 0; pointer-events: none; transition: opacity 0.2s ease; display: flex; backdrop-filter: blur(4px);">
    ...
    <!-- Rename Group Modal -->
    <div id="rename-group-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center; opacity: 0; pointer-events: none; transition: opacity 0.2s ease; display: flex; backdrop-filter: blur(4px);">
    ...
    <!-- Delete Group Modal -->
    <div id="delete-group-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center; opacity: 0; pointer-events: none; transition: opacity 0.2s ease; display: flex; backdrop-filter: blur(4px);">
    ...
    <!-- Kill Instance Modal -->
    <div id="kill-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center; opacity: 0; pointer-events: none; transition: opacity 0.2s ease; display: flex; backdrop-filter: blur(4px);">
    ...
    <div id="remove-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center; opacity: 0; pointer-events: none; transition: opacity 0.2s ease; display: flex; backdrop-filter: blur(4px);">
    ...
    <!-- Kill All Modal -->
    <div id="kill-all-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 1000; align-items: center; justify-content: center; opacity: 0; pointer-events: none; transition: opacity 0.2s ease; display: flex; backdrop-filter: blur(4px);">
...
<script>
            ...
            const translations = {
                "en": {
                    ...
                    "lbl_game_launch_desc": "When filled, clicking \"Launch\" on any account card will automatically launch them into this specific game/server.",
                ...
                "id": {
                    ...
                    "lbl_game_launch_desc": "Jika diisi, menekan \"Launch\" pada kartu akun akan secara otomatis meluncurkannya ke dalam game/server khusus ini.",
            ...
            function saveGameSettings() {
                ...
                if (psLink.length > 0) {
                    let isValidLink = (psLink.includes('roblox.com/games/') && psLink.includes('privateServerLinkCode=')) || 
            ...
            window.showStatus = function(msg, isError) {
                ...
                if (dict) {
                    ...
                    else if (msg === "Place ID cannot be empty when using a Private Server Link!") translatedMsg = dict.toast_placeid_empty || msg;
...
let autoUpdateToggle = document.getElementById('setting-auto-update');
                ...
                if (j.headshotUrl) {
                    ...
                    if (cardEl) {
                        ...
                        if (utilityBtn) {
                            ...
                            if (oldOnclick) {
                                ...
                                utilityBtn.setAttribute('onclick', oldOnclick.replace(/openUtilityModal\('[^']*',\s*'[^']*',\s*'[^']*'/, 
                                    "openUtilityModal('" + currentUtilityCookie.replace(/'/g, "\\'") + "', '" + currentUtilityUserId + "', '" + j.headshotUrl.replace(/'/g, "\\'") + "'"));
                            }
                        }
                    }
                    ...
                    if (typeof currentAccounts !== 'undefined' && currentAccounts) {
                        for (let i = 0; i < currentAccounts.length; i++) {
                            if (currentAccounts[i].UserId == currentUtilityUserId || currentAccounts[i].Id == currentUtilityUserId) {
        ...
        window.fetchRecentGames = function(force = false) {
            ...
            let isId = (document.getElementById('setting-language') && document.getElementById('setting-language').value === 'id');
            document.getElementById('recent-games-container').innerHTML = '<div style="color: var(--text-muted); font-size: 13px; font-style: italic; padding: 12px;">' + (isId ? 'Memuat game terakhir' : 'Loading recent games') + '</div>';
        ...
        window.onReceiveRecentGames = function(jsonStr) {
            ...
            try {
                ...
                if (games && games.length > 0) {
                    games.forEach(game => {
                        let div = document.createElement('div');
                        div.style.cssText = 'min-width: 120px; width: 120px; background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 8px; overflow: hidden; cursor: pointer; transition: transform 0.2s; flex-shrink: 0;';
                        div.onmouseover = () => { div.style.transform = 'translateY(-2px)'; div.style.borderColor = 'var(--text-muted)'; };
                        ...
                        title.style.cssText = 'font-size: 11px; font-weight: 500; padding: 8px; text-align: center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;';
                    ...
                    container.innerHTML = '<div style="color: var(--text-muted); font-size: 13px; font-style: italic; padding: 12px;">' + (isId ? 'Tidak ada game terakhir.' : 'No recent games found.') + '</div>';
                }
            } catch(e) {
        ...
        window.doValidateGameLaunchInputs = function() {
            ...
            const updateState = (input, errorDiv, color, display, errorMsg = "") => {
                if (input.style.borderColor !== color && !(color === '#ef4444' && input.style.borderColor === 'rgb(239, 68, 68)') && !(color === '#10b981' && input.style.borderColor === 'rgb(16, 185, 129)')) {
        ...
        window.openUtilityModal = function(cookie, userId, avatarSrc, username) {
            ...
            setTimeout(() => { updateTabIndicator(0, utilityTabs[0], false); }, 50);
        ...
        window.onReceiveRecentGames = function(jsonStr) {
            ...
            try {
                ...
                let html = '';
                games.forEach(g => {
                    let thumb = g.thumbnail || "https://tr.rbxcdn.com/30DAY-AvatarHeadshot-15E6D8A279B926E6C5779D6BA1D97ACD-Bc/150/150/AvatarHeadshot/Png/noFilter";
                    let name = escapeHtml(g.name);
                    let playing = g.playing || 0;
                    let playingStr = (playing > 0) ? (playing >= 1000 ? (playing / 1000).toFixed(1).replace(/\.0$/, '') + 'K' : playing) : '0';
                    let likeRatio = (g.likeRatio !== undefined && g.likeRatio !== null && g.likeRatio > 0) ? (g.likeRatio + '%') : '-';
                    let likeHtml = `
        ...
        window.launchRecentGame = function(btn, gameId) {
            btn.innerHTML = '<svg class="spinner" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink: 0;"><path d="M21 12a9 9 0 1 1-6.219-8.56"></path></svg>';
            window.chrome.webview.postMessage(JSON.stringify({
                action: 'launch',
                cookie: currentUtilityCookie,
                placeId: gameId,
                    ...
                    try {
                        ...
                        if (errObj && errObj.length > 0 && errObj[0].error) {
                            ...
                            if (ecode === 'RATE_LIMIT_OR_JSON_FAILED') {
                                errorMsg = isId ? 'Terlalu banyak permintaan. Mohon tunggu beberapa saat (Rate Limit).' : 'Too many requests. Please wait a moment (Rate Limit).';
                            } else if (ecode === 'CSRF_FAILED') {
                                errorMsg = isId ? 'Gagal memvalidasi token sesi. Silakan coba lagi.' : 'Failed to validate session token. Please try again.';
        ...
        if (recentGamesContainer && btnScrollLeft && btnScrollRight) {
            recentGamesContainer.addEventListener('scroll', () => {
                ...
                btnScrollRight.style.display = (recentGamesContainer.scrollWidth - recentGamesContainer.scrollLeft > recentGamesContainer.clientWidth + 5) ? 'flex' : 'none';
            });
