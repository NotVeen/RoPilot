...
<head>
    ...
    <style>
        ...
        * { 
        ...
        [data-theme="light"] .nav-item::before { background-color: var(--text-main) !important; }
        ...
        [data-theme="light"] .btn-add-account { background-color: #e5e7eb !important; color: #111827 !important; }
        ...
        [data-theme="light"] .btn-primary:not(.danger) { background-color: #111827 !important; color: #ffffff !important; border: none !important; }
