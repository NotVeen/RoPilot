...
<body>
    ...
    <div id="manage-account-modal" class="modal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.6); z-index: 1000; align-items: center; justify-content: center; opacity: 0; pointer-events: none; transition: opacity 0.3s ease; display: flex; backdrop-filter: blur(4px);">
        <div class="modal-content manage-modal-content" style="position: relative; transform: scale(0.95); transition: transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275); display: flex; flex-direction: column; width: 800px; max-width: 90vw; height: 600px; max-height: 85vh; padding: 0; overflow: hidden; border-radius: 12px; border: 1px solid var(--border-color);">
            <div class="manage-topbar" style="position: relative; display: flex; align-items: center; justify-content: center; gap: 32px; padding: 12px 24px; border-bottom: 1px solid var(--border-color);">
            ...
            <div class="manage-content" style="flex-grow: 1; padding: 32px 48px; overflow-y: auto; display: flex; flex-direction: column; position: relative;">
                <div id="manage-loading" style="display: flex; flex-direction: column; align-items: center; justify-content: center; position: absolute; inset: 0; background: var(--bg-card); z-index: 10;">
                    <svg class="spinner" viewBox="0 0 50 50" style="width: 40px; height: 40px; margin-bottom: 16px; stroke: var(--text-main);"><circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="5" stroke-linecap="round"></circle></svg>
                    <span data-i18n="lbl_fetching_details" style="color: var(--text-muted); font-weight: 500;">Fetching account details...</span>
                </div>
                
                <div id="manage-home" class="manage-page" style="display: none; flex-direction: column; gap: 32px; animation: fadeSlideIn 0.3s ease forwards;">
                    ...
                    <div class="manage-overview-list" style="display: flex; flex-direction: column; gap: 0; border: 1px solid var(--border-color); border-radius: 12px; overflow: hidden;">
                        <div class="overview-item" style="display: flex; align-items: center; padding: 16px 20px; border-bottom: 1px solid var(--border-color);">
                            ...
                            <div class="overview-text" style="flex-grow: 1;">
                                <span class="overview-label" style="font-size: 12px; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Username</span>
                        ...
                        <div class="overview-item" style="display: flex; align-items: center; padding: 16px 20px; border-bottom: 1px solid var(--border-color);">
                            ...
                            <div class="overview-text" style="flex-grow: 1;">
                                <span class="overview-label" data-i18n="lbl_display_name" style="font-size: 12px; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Display Name</span>
                        ...
                        <div class="overview-item" style="display: flex; align-items: center; padding: 16px 20px; border-bottom: 1px solid var(--border-color);">
                            ...
                            <div class="overview-text" style="flex-grow: 1;">
                                <span class="overview-label" data-i18n="lbl_user_id" style="font-size: 12px; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">User ID</span>
                        ...
                        <div class="overview-item" style="display: flex; align-items: center; padding: 16px 20px; border-bottom: 1px solid var(--border-color);">
                            <div class="overview-icon" style="margin-right: 16px; width: 24px; display: flex; justify-content: center;">
                                <img src="https://img.icons8.com/color/48/robux--v2.png" style="width: 20px; height: 20px;" class="dynamic-icon"/>
                            </div>
                            <div class="overview-text" style="flex-grow: 1;">
                                <span class="overview-label" style="font-size: 12px; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Robux</span>
                ...
                <div id="manage-placeholder" class="manage-page" style="display: none; align-items: center; justify-content: center; height: 100%; color: var(--text-muted); animation: fadeSlideIn 0.3s ease forwards;">
