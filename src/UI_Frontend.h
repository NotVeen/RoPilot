...
<script>
            ...
            const translations = {
                "en": {
                    ...
                    "desc_display_name_warning": "⚠️ Your Display Name can only be changed once every 7 days.",
                ...
                "id": {
                    ...
                    "desc_display_name_warning": "⚠️ Display Name hanya dapat diubah satu kali setiap 7 hari.",
